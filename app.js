// Function to track drinks
function trackDrinks() {
    ...
    const drinkLimit = parseFloat(document.getElementById('drinkLimit').value) || 3;
    
    // Update display
    const drinkStatus = document.querySelector('.drink-status');
    const soberTime = document.getElementById('sober-time');
    
    if (drinkStatus && soberTime) {
        // Update status based on drink count relative to user's limit
